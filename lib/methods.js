Meteor.methods({
  ...
  set_editor: function(user_id, is_editor) {
    ...
    Meteor.call('send_email', {
      ...
      subject: "You're a Timelined editor now, " + user.username,
      text: "Your trial episode was awesome, it's time for the real thing. "
  ...
  update_user_form: function (doc) {
    ...
    if (user_id) {
      ...
      Meteor.users.update({_id: user_id}, {
        $set: {
          completed_trial:doc.completed_trial, signed_editor_legal:doc.signed_editor_legal
        }
      });
    }
  }
