Meteor.methods({
  ...
  new_sponsor: function(name, episode_id) {
    console.log('hey yo in new_sponsr');
  ...
  set_editor: function(user_id, is_editor) {
    ...
    Meteor.call('send_email', {
      ...
      <li>Watch the <a href='http://s3.amazonaws.com/timelined/video/75b2906cb146d9d0e4bec884846c00ec.mp4'>Editor Screencast</a></li>\
      <li>Contact us anytime with questions of feedback</li></ul></p>\
      <p>Happy Timelining!</p><br><br>Sincerely,<br>The Timelined Team<br>support@timelined.com"
    });
  },
